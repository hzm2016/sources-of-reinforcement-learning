...
## Codes
 ...
 - [Code for real robot examples](https://github.com/kindredresearch/SenseAct) - implemented in real physical robots
 - [Benchmarking of model-based reinforcement learning](https://arxiv.org/abs/1907.02057) - all the model-based reinforcement learning algorithms
...
Methods
 ...
 - Deep Learning + Reinforcement Learning (A sample of recent works on DL+RL)
   ...
   - Kalman Filter
    - [The basic lecture](http://web.mit.edu/kirtley/kirtley/binlustuff/literature/control/Kalman%20filter.pdf)
